...
Unpacking the CIDRs into a individual IP records generally doesn't make sense as it would be time consuming to build the database and create a much larger than necessary database.
